/*
 * TimmeParameterInferenceEngine.h
 *
 *  Created on: 21 Dec 2013
 *      Author: rusty
 */

#ifndef TIMMEPARAMETERINFERENCEENGINE_H_
#define TIMMEPARAMETERINFERENCEENGINE_H_
...
class TimmeParameterInferenceEngine : public IInferenceEngine
{
...
public:
	...
	TimmeParameterInferenceEngine(int ID, int unitCount, int nTimesteps, int unitDimension, int parametersPerUnit, IDynamicalUnit** units , double timestepSize);
...
#endif /* TIMMEPARAMETERINFERENCEENGINE_H_ */
